...
function DesignSummerSchool() {
    return (
        <div style={{ fontFamily: 'Arial, sans-serif', color: '#333' }}>
            <header className="Application-header" style={{ display: 'flex', alignItems: 'center', justifyContent: '', padding: '20px', backgroundColor: '#f5f5f5' }}>
                <a href="/">
            ...
            <div className="container-1" style={{ backgroundImage: 'url("https://www.immerse.education/wp-content/uploads/2015/12/Cambridge-scaled-1.png")', backgroundSize: 'cover', padding: '50px', color: '#fff', textAlign: 'center' }}>
                <div className="content-1">
                    <h1 className="head-1" style={{ fontSize: '48px', marginBottom: '20px' }}>
                        Unlock<br /> Your<br /> Potential
                    </h1>
                    <button className="button-1" style={{ padding: '10px 20px', fontSize: '16px', backgroundColor: '#007BFF', color: '#fff', border: 'none', borderRadius: '5px', cursor: 'pointer', marginBottom: '20px' }}>
                        Register
                    </button>
            ...
            <div className="container-2" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '50px', backgroundColor: '#f9f9f9' }}>
                <img src="https://iiitd.ac.in/dss/public/notes-2-1400w.png" alt="Design Elements" style={{ width: '50%', marginRight: '20px' }} />
                <h1 className="content-2" style={{ fontSize: '36px' }}>
                    Learn.<br /> Connect.<br /> Grow.
                </h1>
            </div>
            <div className="container-3" style={{ padding: '50px', backgroundColor: '#fff' }}>
                <h2>About the Summer School</h2>
                <div className="content-3" style={{ display: 'flex', justifyContent: 'space-between', marginTop: '20px' }}>
                    ...
                    <div className="contact-us" style={{ width: '35%', textAlign: 'right' }}>
            ...
            <div className="container-4" style={{ padding: '50px', backgroundColor: '#f5f5f5', textAlign: 'center' }}>
                ...
                <div className="content-4" style={{ marginTop: '20px', fontSize: '18px' }}>
                    ...
                    <br />
                    <button className="button-2" style={{ padding: '10px 20px', fontSize: '16px', backgroundColor: '#28a745', color: '#fff', border: 'none', borderRadius: '5px', cursor: 'pointer', marginTop: '20px' }}>
